...
function info(){
  buildingInfo = [
    [ //Housing
      {name : "Woven Hut",time : 1,resources : {Wood:10,Stone:89},benifits : function(){playerInfo.production.WoodPH.amount += 10;}}
      ,{name : "Wove Hut",time : 3,resources : {Wood:120,Stone:849},benifits : function(){}}
    ...
    [//sector 3
        {name : "Smagggggggggggggxbll"}
        ,{name : "smxbxab"},{name : "snymbab"}
    ],
    [ //sector 4
        {name : "smafhfxbb"},{name : "sbxvfhnbmab"},{name : "sg fmxbab"}
    ...
    [ //sector 6
        {name : "smafnb"},{name : "smcfggnab"},{name : "smacnb"}
  ...
  playerInfo = {
    ...
    unroundedResources : {},
    production : {
     WoodPH  : {pointer:"Wood",amount:36001},
     StonePH : {pointer:"Stone"},
    ...
    initializeProduction : function(){
        for (let [key, value] of Object.entries(playerInfo.production)) {
          if(!playerInfo.production[key].amount){
            Object.defineProperty(playerInfo.production[key],"amount",{value:0,writable:true});
          }
...
addBuildings = function(amount,section,order){
 ...
 function startTimer(timeS,section,order,amount)  {
    ...
    for(i = 0; i< Object.values(buildingInfo[section][order].resources).length; i++){
        ...
        Object.defineProperty(playerInfo.resources,Object.keys(buildingInfo[section][order].resources)[i],{value:l});
        print(playerInfo)
